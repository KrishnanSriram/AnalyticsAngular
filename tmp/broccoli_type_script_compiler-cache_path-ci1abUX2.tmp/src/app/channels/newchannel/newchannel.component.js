...
var NewchannelComponent = (function () {
    function NewchannelComponent(channelService, formBuilder, renderer) {
        ...
        this.channelForm = formBuilder.group({
            ...
            'isPrivate': [true, forms_1.Validators.required]
        });
    ...
    ], NewchannelComponent.prototype, "modalCancelDismiss", void 0);
