...
var channels_routing_1 = require('./channels.routing');
var ChannelsModule = (function () {
    function ChannelsModule() {
    }
    ChannelsModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, channels_routing_1.routing],
            declarations: [channels_component_1.ChannelsComponent],
            exports: [channels_component_1.ChannelsComponent],
